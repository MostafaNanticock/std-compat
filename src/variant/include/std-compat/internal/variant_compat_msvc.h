...
#define _PM_HAS_STD_BAD_VARIANT_ACCESS_UCRT_14_44_X_X _PM_CC_SUPPORTS_CXX17 && (STDC_CRT_VERSION_MAJOR == 14) && (STDC_CRT_VERSION_MINOR >= 44)
#define _PM_HAS_STD_BAD_VARIANT_ACCESS_UCRT_14_29_X_X PM_CPP_VERSION >= 201703L && (STDC_CRT_VERSION_MAJOR == 14) && (STDC_CRT_VERSION_MINOR >= 29)
#define _PM_HAS_STD_BAD_VARIANT_ACCESS_UCRT_14_16_X_X PM_CPP_VERSION >= 201703L && (STDC_CRT_VERSION_MAJOR == 14) && (STDC_CRT_VERSION_MINOR >= 16)
